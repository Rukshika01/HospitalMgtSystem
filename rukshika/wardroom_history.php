...
$sql = " SELECT DISTINCT ward_room.wardroom_id,patient.patient_id,patient.patient_name,patient.admitted_date,invoice.discharge_date FROM patient INNER JOIN ward_room on patient.wardroom_id = ward_room.wardroom_id INNER JOIN invoice on invoice.patient_id = patient.patient_id";
